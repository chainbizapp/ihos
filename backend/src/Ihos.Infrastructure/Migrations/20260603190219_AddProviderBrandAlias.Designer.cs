...
namespace Ihos.Infrastructure.Migrations
{
    ...
    [Migration("20260603190219_AddProviderBrandAlias")]
    partial class AddProviderBrandAlias
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ihos.Domain.Entities.ProviderBrandAlias", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("CanonicalMakeId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CanonicalMakeId");

                    b.HasIndex("ProviderCode", "RawValue")
                        .IsUnique();

                    b.ToTable("provider_brand_aliases", (string)null);
                });
            ...
            modelBuilder.Entity("Ihos.Domain.Entities.VehicleSyncLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("vehicle_sync_logs", (string)null);
                });
            ...
            modelBuilder.Entity("Ihos.Domain.Entities.ProviderBrandAlias", b =>
                {
                    b.HasOne("Ihos.Domain.Entities.VehicleMake", "CanonicalMake")
                        .WithMany()
                        .HasForeignKey("CanonicalMakeId")
                        .OnDelete(DeleteBehavior.SetNull);
